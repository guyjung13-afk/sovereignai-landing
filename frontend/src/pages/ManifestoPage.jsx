  ...
  return (
    <>
      ...
      <div className="manifesto-page">
        ...
        <h1>The Sovereign <span className="gold">Manifesto</span></h1>
        ...
        <section>
          ...
          <p style={{ color: "#D4AF37", fontWeight: 600, letterSpacing: "0.02em" }}>
        ...
        <section>
          <h3>The Definition of Sovereignty</h3>
          <p>
        ...
        <section style={{ textAlign: "center", paddingTop: 80 }}>
          <div style={{ fontFamily: "'Inter', sans-serif", fontSize: "clamp(24px, 3vw, 40px)", letterSpacing: "0.1em", fontWeight: 800, color: "#D4AF37", marginBottom: 40 }}>
